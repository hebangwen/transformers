...
class Qwen3NextDynamicCache:
    ...
    For attention layers, `key_cache` and `value_cache` have a shape of `(batch_size, sequence_length, seq_len, head_dim)`,
...
class Qwen3NextForCausalLM(MixtralForCausalLM):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        r"""
        labels (`torch.LongTensor` of shape `(batch_size, num_heads)`, *optional*):
